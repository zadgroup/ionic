...
import { Color, Config, Mode, SearchbarGqlChangeEventDetail } from '../../interface';
import { debounceEvent } from '../../utils/helpers';
import { createColorClasses } from '../../utils/theme';

@Component({
  tag: 'ion-searchbar-gql',
  styleUrls: {
    ios: 'searchbar-gql.ios.scss',
    md: 'searchbar-gql.md.scss'
  },
  scoped: true
})
export class SearchbarGql implements ComponentInterface {
   ...
   */
  @Event() ionChange!: EventEmitter<SearchbarGqlChangeEventDetail>;
  ...
  protected valueChanged() {
    const inputEl = this.searchbarEl;
  ...
  getInputElement(): Promise<HTMLInputElement> {
    return Promise.resolve(this.searchbarEl!.getInputElement());
  }
  ...
  private onCancelSearchbar = async (ev?: Event) => {
    ...
    if (this.searchbarEl) {
      (await this.searchbarEl.getInputElement()).blur();
    }
  }
  ...
  render() {
    return <div class="searchbar-gql-input-container">
        <ion-searchbar
          ref={el => this.searchbarEl = el as HTMLIonSearchbarElement}
          class="searchbar"
          ...
          onIonCancel={this.onCancelSearchbar}
          onIonClear={this.onClearInput}
        />
      </div>;
  }
}
